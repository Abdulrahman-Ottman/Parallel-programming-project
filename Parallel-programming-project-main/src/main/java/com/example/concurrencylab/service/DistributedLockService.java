...
public class DistributedLockService {
    ...
    /**
     * ينفذ عملية محمية بـ Distributed Pessimistic Lock عبر Redis.
     *
     * @param lockKey   مفتاح القفل في Redis — مثال: "lock:inventory:42"
     *                  (قفل منفصل لكل منتج حتى لا يتعارض المنتجان المختلفان)
     * @param waitTime  أقصى وقت انتظار للحصول على القفل (ثوانٍ)
     * @param leaseTime مدة القفل قبل الإلغاء التلقائي — يمنع Dead Lock
     *                  لو مات الخيط فجأة بدون unlock
     * @param operation العملية الحساسة المطلوب تنفيذها داخل القفل
